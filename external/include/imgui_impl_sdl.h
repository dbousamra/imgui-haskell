...
extern "C" bool     ImGui_ImplSDL2_InitForOpenGL(SDL_Window* window, void* sdl_gl_context);
extern "C" bool     ImGui_ImplSDL2_InitForVulkan(SDL_Window* window);
extern "C" void     ImGui_ImplSDL2_Shutdown();
extern "C" void     ImGui_ImplSDL2_NewFrame(SDL_Window* window);
